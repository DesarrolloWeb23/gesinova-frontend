...
export default function MenuTransfer() {
    ...
    return (
        <div className="flex justify-end gap-2">
            ...
            <div className="group relative inline-flex h-[50px] w-[70px] items-center justify-center rounded-md transition-all duration-200 ease-in hover:w-[130px] overflow-hidden" onClick={() => setView("lectern")}>
                <span className="absolute left-[18px] flex items-center justify-center">
