...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("group/menu-item relative mt-2 ml-2", className)}
      {...props}
    />
  )
}
